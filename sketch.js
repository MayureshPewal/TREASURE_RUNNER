var path,boy,cash,diamonds,jwellery,sword,over,restart;
var pathImg,boyImg,cashImg,diamondsImg,jwelleryImg,swordImg,overImg,restartImg;
...
function draw() {
  ...
  if(path.y > height ){
    ...
    if (cashG.isTouching(boy)) {
     ...
     over = createSprite(windowWidth/2,windowHeight/2,0,0);  
